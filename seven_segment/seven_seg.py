class SevenSegmentDisplay:
    ...
    def insert_in_a_list(self):
        ...
        if len(my_list) > 8 or len(my_list) < 8:
            raise ValueError("Input should not be more than or less than 7 numbers")
        return my_list

    def print(self):
        list1 = self.insert_in_a_list()
        if list1[7] == '1':
...
if __name__ == '__main__':
    ...
    segment = SevenSegmentDisplay(user_input)
    segment.print()
